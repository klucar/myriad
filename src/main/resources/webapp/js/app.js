...
var ClustersComponent = require('./components/ClustersComponent')
...
var routes = (
  <Route name="myriad" path="/" handler={Myriad} >
    <Route name="clusters" path="clusters" handler={ClustersComponent} />
...
//React.render(
//  <Myriad/>, document.getElementById("myriad")
//);
